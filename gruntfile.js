  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js_copy: {
        ...
        tasks: ['copy:javascripts', 'exec:kit:javascripts/*.js']
      },
      ...
      img_copy: {
        ...
        tasks: [ 'copy:images', 'exec:kit:images/*']
      },

      img_minify: {
        files: 'sources/images/minify/*',
        tasks: ['imagemin:build_images', 'exec:kit:images/*']
      },

      assets_copy: {
        files: 'sources/assets/copy/*',
        tasks: ['copy:assets', 'exec:kit:assets/*']
      },

      assets_minify: {
        files: 'sources/assets/minify/*',
        tasks: ['imagemin:build_assets', 'exec:kit:assets/*']
      },
